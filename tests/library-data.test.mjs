...
test("normalizes all 28 Library records from one metadata source", () => {
  ...
  assert.deepEqual(counts, { article: 4, prompt: 9, excerpt: 15 });
  assert.equal(items[0].updated, "2026-08-21");
