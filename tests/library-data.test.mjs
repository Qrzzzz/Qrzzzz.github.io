...
test("normalizes all 16 Library records from one metadata source", () => {
  ...
  assert.deepEqual(counts, { article: 3, prompt: 7, excerpt: 6 });
  assert.equal(items[0].updated, "2026-07-27");
