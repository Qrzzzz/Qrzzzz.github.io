...
test("normalizes all 17 Library records from one metadata source", () => {
  ...
  assert.deepEqual(counts, { article: 3, prompt: 8, excerpt: 6 });
  assert.equal(items[0].updated, "2026-07-28");
