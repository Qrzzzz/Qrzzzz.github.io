...
test("normalizes all 22 Library records from one metadata source", () => {
  ...
  assert.deepEqual(counts, { article: 4, prompt: 8, excerpt: 10 });
  assert.equal(items[0].updated, "2026-08-03");
